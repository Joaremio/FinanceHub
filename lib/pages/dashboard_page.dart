...
import 'package:financehub/widgets/market_quotes_carousel.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/material.dart';

enum DashboardPeriod { month, year }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [green, green.withOpacity(0.82)],
    ...
    if (transactions.isEmpty) {
      return Card(
        ...
        child: const Padding(
          ...
          child: Column(
            children: [
              Icon(Icons.receipt_long_rounded, size: 42, color: Colors.grey),
              SizedBox(height: 12),
              Text(
